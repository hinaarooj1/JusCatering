...
exports.submitOrder = catchAsyncErrors(async (req, res, next) => {
  ...
  **Additional Notes:**
  ...
  // Respond to the client indicating the form was submitted successfully
  res.status(200).send({
    success: true,
    msg: "Form submitted successfully",
  });
});
exports.submitMessage = catchAsyncErrors(async (req, res, next) => {
  ...
  let subject = `Jus Catering contact form information`;
